        ...
        if (!$nome || !$email) {
            ...
            try {
                ...
                if (str_contains($e->getMessage(), 'UNIQUE')) {
                    $error = 'Este e-mail já está cadastrado para outro profissional.';
                } else {
...
render_admin_header('Novo Profissional', 'clientes');
?>
    ...
    <form method="post" id="clientForm" style="background:var(--card); border:1px solid var(--border); border-radius:1.5rem; padding:2.5rem; box-shadow:var(--shadow-sm);">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;">
            ...
            <div style="grid-column: span 2; display:flex; flex-direction:column; gap:0.5rem;">
                ...
                <input type="text" name="nome" required style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>

            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                <label style="font-size:0.875rem; font-weight:600;">E-mail *</label>
                <input type="email" name="email" required style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>

            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                <label style="font-size:0.875rem; font-weight:600;">Telefone Principal *</label>
                <input type="text" name="telefone" id="telefone" required maxlength="15" placeholder="(00) 00000-0000" style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
                <label style="font-size:0.75rem; display:flex; align-items:center; gap:0.5rem; cursor:pointer; color:var(--muted-foreground); margin-top:0.25rem;">
                    <input type="checkbox" id="syncWhatsapp"> WhatsApp é o mesmo do telefone
                </label>
            </div>
            ...
            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                ...
                <input type="text" name="cep" id="cep" placeholder="00000-000" style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>

            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                <label style="font-size:0.875rem; font-weight:600;">Logradouro (Rua)</label>
                <input type="text" name="rua" id="rua" style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>

            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                <label style="font-size:0.875rem; font-weight:600;">Bairro</label>
                <input type="text" name="bairro" id="bairro" style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>

            <div style="display:flex; flex-direction:column; gap:0.5rem;">
                <label style="font-size:0.875rem; font-weight:600;">Cidade</label>
                <input type="text" name="cidade" id="cidade" style="padding:0.75rem 1rem; border:1px solid var(--border); border-radius:0.75rem; background:var(--muted-bg); color:var(--foreground);">
            </div>
        ...
        <button type="submit" class="btn btn-primary" style="margin-top:2rem; width:100%; padding:1rem; border-radius:0.75rem; font-weight:700;">Cadastrar Profissional</button>
    </form>
</div>
