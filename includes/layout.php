...
function render_footer(): void
{
    ...
    echo '<a href="https://www.instagram.com/conectadoemsergipe/" aria-label="Instagram" target="_blank" rel="noopener"><i data-lucide="instagram" style="width:20px; height:20px;"></i></a>';
    echo '<a href="https://www.youtube.com/@ConectadoemSergipe" aria-label="YouTube" target="_blank" rel="noopener"><i data-lucide="youtube" style="width:20px; height:20px;"></i></a>';
    echo '</div></div>';
